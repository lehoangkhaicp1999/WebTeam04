    ...
    <div className="col col-lg-9">
      ...
      <div className="row mt-4 mb-1 size"><nav aria-label="breadcrumb">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item " aria-current="page">Quần Vải</li>
            <li className="breadcrumb-item active" aria-current="page">Quần Ống Suông Đứng</li>
          </ol>
        </nav></div>
      <div className="row">
