    ...
    <div className="col col-lg-9">
      ...
      <div className="row mt-4 mb-1 size"><nav aria-label="breadcrumb">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item " aria-current="page">Áo Sơ Mi | Áo Kiểu</li>
            <li className="breadcrumb-item active" aria-current="page">Áo Kiểu</li>
          </ol>
        </nav></div>
      <div className="row">
